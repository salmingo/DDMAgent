/*
 * 连接NTP服务, 查询本地时钟与NTP时钟的偏差, 并修正时钟偏差
 **/
using System;
using System.Net;
...
namespace TimeSync
{
    ...
    public class NTPClient
    {
        ...
        public TimeSpan clockCorrect;
        public bool validCorrect = false;
        ...
        public void Connect(bool UpdateSystemTime)
        {
            try
            {
                ...
                if (IsResponseValid())
                {
                    ...
                    clockCorrect = TransmitTimestamp - ReceptionTimestamp;
                    validCorrect = true;
                }
            }
